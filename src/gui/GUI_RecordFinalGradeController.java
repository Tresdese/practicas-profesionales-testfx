...
public class GUI_RecordFinalGradeController {
    ...
    private boolean gradeSaved = false;
    ...
    private void initialize() {
        ...
        if (saveGradeButton != null) {
            saveGradeButton.setOnAction(e -> handleSaveFinalGrade());
        }
    }

    public void setStudent(StudentDTO student) {
        this.student = student;
        if (student != null && student.getFinalGrade() > 0) {
    ...
    public boolean isGradeSaved() {
        return gradeSaved;
    }

    @FXML
    public void handleSaveFinalGrade() {
