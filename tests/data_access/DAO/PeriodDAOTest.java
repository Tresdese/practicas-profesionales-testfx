...
class PeriodDAOTest {
    ...
    void testInsertPeriod() {
        try {
            ...
            PeriodDTO insertedPeriod = periodDAO.getPeriod("202601", connection);
    ...
    void testGetPeriod() {
        try {
            ...
            PeriodDTO retrievedPeriod = periodDAO.getPeriod("202651", connection);
    ...
    void testUpdatePeriod() {
        try {
            ...
            PeriodDTO retrievedPeriod = periodDAO.getPeriod("202701", connection);
    ...
    void testDeletePeriod() {
        try {
            ...
            boolean result = periodDAO.deletePeriod("202651", connection);
            assertTrue(result, "La eliminación debería ser exitosa");

            PeriodDTO deletedPeriod = periodDAO.getPeriod("202651", connection);
