...
class RepresentativeDAOTest {
    ...
    void setUp() {
        ...
        try {
            ...
            fail("Error al limpiar la tabla representante: " + e.getMessage());
        }
    }
    ...
    void testInsertRepresentative() {
        try {
            RepresentativeDTO representative = new RepresentativeDTO(
                    "1", "Nombre Test", "Apellido Test", "test@example.com", "1"
            );
    ...
    void testSearchRepresentativeById() {
        try {
            ...
            fail("Error en testSearchRepresentativeById: " + e.getMessage());
        }
    }
    ...
    void testUpdateRepresentative() {
        try {
            ...
            RepresentativeDTO repToUpdate = new RepresentativeDTO(
                    "3", "Nombre Actualizado", "Apellido Actualizado", "actualizado@example.com", "4"
            );
    ...
    void testDeleteRepresentative() {
        try {
            insertTestRepresentative("4", "Nombre Delete", "Apellido Delete", "delete@example.com", "5");
    ...
    void testGetAllRepresentatives() {
        try {
            insertTestRepresentative("5", "Nombre Lista", "Apellido Lista", "lista@example.com", "6");
